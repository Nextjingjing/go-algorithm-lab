...
When the learner completes an exercise with its implementation, tests, and
runnable `cmd/` example, update `README.md` and `docs/learning-plan.md` in the
same turn. If the conversation contains new evidence about the learner's own
attempt, debugging, explanation, or replay, also update
`docs/learner-profile.md` in that turn; do not wait for the learner to request
the documentation update separately.
