...
| Left and Right Sum Differences | [LC #2574](https://leetcode.com/problems/left-and-right-sum-differences/) | Implementation, tests, and cmd example complete | explain why `total - nums[i] - leftSum[i]` is the right-side sum |
